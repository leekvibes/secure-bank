...
const TEMPLATES: Array<{
  ...
  // ── Document Templates (new) ───────────────────────────────────────────────
  {
    ...
    docSchemaJson: docSchema("Non-Disclosure Agreement", [
      "1. Definition of Confidential Information. For purposes of this Agreement, Confidential Information means all non-public business, financial, technical, operational, and customer information disclosed by either party, whether oral, written, electronic, or visual.",
      "2. Permitted Use. Receiving party may use Confidential Information solely for evaluating, supporting, or performing the business relationship between the parties and for no other purpose without prior written consent.",
      "3. Standard of Care. Receiving party shall protect Confidential Information using at least the same degree of care it uses to protect its own confidential materials, and in no event less than reasonable care.",
      "4. Exclusions. Confidential Information does not include information that is publicly available through no breach, already known to the receiving party without restriction, independently developed, or rightfully received from a third party.",
      "5. Compelled Disclosure. If legally compelled to disclose Confidential Information, receiving party shall provide prompt notice where permitted and disclose only the minimum required by law.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Offer Letter", [
      "1. Position and Start Date. {{party_a_name}} offers {{party_b_name}} the role described in this Offer Letter, with an anticipated start date of {{term_start_date}}.",
      "2. Reporting and Duties. The employee will report to leadership designated by {{party_a_name}} and perform duties consistent with business needs and job expectations.",
      "3. Compensation. Base compensation is set at {{consideration}} and is subject to standard payroll, withholding, and policy requirements.",
      "4. Work Location and Policies. Employee acknowledges receipt of workplace rules, confidentiality standards, and conduct policies maintained by {{party_a_name}}.",
      "5. Contingencies. This offer is contingent on identity verification, any required background checks, and execution of onboarding documents.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Bill of Sale", [
      "1. Parties. This Bill of Sale is made effective {{effective_date}} by and between seller {{party_a_name}} and buyer {{party_b_name}}.",
      "2. Transfer of Property. Seller transfers to Buyer all right, title, and interest in the described property for the agreed purchase terms.",
      "3. Purchase Price. Buyer agrees to pay {{consideration}} to Seller as full consideration for the transfer unless otherwise stated in writing.",
      "4. Condition of Property. Except as explicitly stated in this document, property is transferred in its present condition and Buyer confirms opportunity to inspect.",
      "5. Seller Representations. Seller represents lawful ownership and authority to transfer the property, free of undisclosed liens to Seller's knowledge.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Lease Agreement", [
      "1. Premises and Parties. This Lease Agreement is entered on {{effective_date}} between landlord {{party_a_name}} and tenant {{party_b_name}}.",
      "2. Lease Term. The lease term begins on {{term_start_date}} and ends on {{term_end_date}}, unless terminated earlier under this Agreement.",
      "3. Rent and Charges. Tenant agrees to pay rent and related charges in the amount of {{consideration}} according to agreed payment procedures.",
      "4. Security Deposit and Fees. Any required security deposit, pet fees, or service fees must be paid and handled as permitted by applicable law.",
      "5. Use and Occupancy. Tenant shall use premises lawfully, maintain reasonable care, and avoid nuisance, unlawful conduct, or unauthorized occupants.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Loan Agreement", [
      "1. Loan Parties and Date. This Loan Agreement is entered into on {{effective_date}} between lender {{party_a_name}} and borrower {{party_b_name}}.",
      "2. Principal and Purpose. Lender agrees to make available principal funds to Borrower in the amount of {{consideration}} for lawful use.",
      "3. Disbursement and Commencement. Loan term begins on {{term_start_date}} and repayment obligations continue through {{term_end_date}} unless prepaid or modified.",
      "4. Repayment Terms. Borrower shall repay principal, interest, and any agreed charges according to the repayment schedule or written instructions provided by Lender.",
      "5. Prepayment and Fees. Borrower may prepay as allowed by this Agreement; any prepayment fees or penalties must be expressly disclosed in writing.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Service Agreement", [
      "1. Parties and Effective Date. This Service Agreement is entered as of {{effective_date}} between service provider {{party_a_name}} and client {{party_b_name}}.",
      "2. Scope of Services. Provider will perform agreed services, deliverables, and milestones in accordance with professional standards and timelines.",
      "3. Term and Timeline. Services begin on {{term_start_date}} and continue through {{term_end_date}} unless terminated earlier under this Agreement.",
      "4. Fees and Payment. Client shall pay {{consideration}} and any approved expenses pursuant to invoicing and payment terms agreed by the parties.",
      "5. Client Responsibilities. Client will provide timely information, approvals, and access reasonably required for Provider to perform services.",
  ...
  },
  {
    ...
    docSchemaJson: docSchema("Independent Contractor Agreement", [
      "1. Contractor Relationship. {{party_b_name}} will provide services as an independent contractor to {{party_a_name}}, not as an employee, partner, or agent unless explicitly stated.",
      "2. Services and Deliverables. Contractor shall perform services described by the parties and meet agreed quality and timeline requirements.",
      "3. Term. Engagement starts on {{term_start_date}} and continues through {{term_end_date}} unless terminated earlier under this Agreement.",
      "4. Compensation. Contractor shall be paid {{consideration}} according to the payment schedule and invoicing method agreed in writing.",
      "5. Taxes and Benefits. Contractor is solely responsible for taxes, insurance, and statutory obligations and is not eligible for employee benefits.",
