...
import {
  ArrowLeft, ArrowRight, Copy, CheckCheck, Shield, Loader2, CreditCard,
...
> = {
  ...
  ID_UPLOAD: {
    ...
    subtitle: "Client uploads any document, photo ID, or signed paper — photo or PDF",
    defaultExpiry: 24,
    previewFields: ["Document front (required)", "Document back (optional)"],
    infoText: "Your client photographs or scans any document — government ID, SSN card, birth certificate, or any paper. You choose the document type and whether both sides are needed.",
    accentHsl: "35 90% 55%",
  },
  CUSTOM_FORM: {
    icon: FileText,
